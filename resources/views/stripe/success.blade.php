            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col items-center">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Stripe Payment Successful!</h3>
                        <p class="text-gray-700 mb-6">Your Stripe payment has been processed successfully.</p>
